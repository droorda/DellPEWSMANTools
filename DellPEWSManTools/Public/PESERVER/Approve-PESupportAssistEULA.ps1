<#
Approve-PESupportAssistEULA.ps1 - Accept EULA terms and conditions required for support assist registration and running supportassistcollection.
...
#>
function Approve-PESupportAssistEULA
{
